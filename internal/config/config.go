...
type Config struct {
	...
	ThemeMode          string  `json:"theme_mode"`           // "dark" or "light", default "dark"
	...
	ClosedRetentionMin int     `json:"closed_retention_min"` // minutes to show closed sessions, default 5
	Language           string  `json:"language"`             // "ko" or "en", default "ko"
	CompactMode        bool    `json:"compact_mode"`         // show only title bar + usage bars
}
